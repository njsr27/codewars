...
public class EnoughIsEnoughTest {
  ...
  @Test
  public void deleteNth6() {
    assertArrayEquals(
      new int[]{},
      EnoughIsEnough.deleteNth(new int[]{1, 2, 3, 1, 1, 2, 1, 2, 3, 3, 2, 4, 5, 3, 1}, 0)
    );
  }
